...
class TestDatabaseModels:
    ...
    async def test_create_embedding_request(self, session):
    ...
    async def test_create_search_request(self, session):
    ...
    async def test_dedup_check(self, session):
        from src.db.repositories import EmbeddingRequestRepository
    ...
    async def test_get_pending_with_skip_locked(self, session):
        from src.db.repositories import EmbeddingRequestRepository
